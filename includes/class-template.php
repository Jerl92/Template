...
class Template {
	 ...
	 *
	 * - Template_Loader. Orchestrates the hooks of the plugin.
	 * - Template_i18n. Defines internationalization functionality.
	 * - Template_Admin. Defines all hooks for the admin area.
	 * - Template_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-template-admin.php';
	 ...
	 *
	 * Uses the Template_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Template_Admin( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Template_Loader    Orchestrates the hooks of the plugin.
	 */
